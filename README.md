...
*Interactive command-line interface for collecting patient medical data including glucose levels, BMI, blood pressure, and other key diagnostic parameters.*
